...
void TEST_4_offsets()
{
    ...
    fastdtw_cpp::downsampling::offset_vector<3>(1024, 10, offsets);
...
{
    std::vector<unsigned int> offsets;
    fastdtw_cpp::downsampling::offset_vector<2>(1000, 42, offsets);
//    assert();
//    assert();
//    assert();
//    assert();
...
void TEST_mean() {
    ...
    const double mean = fastdtw_cpp::downsampling::mean<double, 5>::perform(data);
...
void TEST_dot() {
    ...
    const double dot = fastdtw_cpp::downsampling::dot<double, 5>::perform(data, data);
...
void TEST_filterBox() {
    ...
    const double result = fastdtw_cpp::downsampling::filter<double, FILTER_TYPE_BOX, 5>::perform(data);
...
void TEST_filterBinomial() {
    ...
    double target = (
        (data[0] * fastdtw_cpp::downsampling::binomial_kernel<double, 5, 0>::value) +
        (data[1] * fastdtw_cpp::downsampling::binomial_kernel<double, 5, 1>::value) +
        (data[2] * fastdtw_cpp::downsampling::binomial_kernel<double, 5, 2>::value) +
        (data[3] * fastdtw_cpp::downsampling::binomial_kernel<double, 5, 3>::value) +
        (data[4] * fastdtw_cpp::downsampling::binomial_kernel<double, 5, 4>::value)
    );

    std::cout << target << std::endl;

    const double result = fastdtw_cpp::downsampling::filter<double, FILTER_TYPE_BINOMIAL, 5>::perform(data);
...
void TEST_downSamplingBox() {
    ...
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BOX, 3>(signal_data, signal_length, signal_data2);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BOX, 3>(signal_data2, signal_length2, signal_data3);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BOX, 3>(signal_data3, signal_length3, signal_data4);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BOX, 3>(signal_data4, signal_length4, signal_data5);
    ...
    std::cout << std::endl;
    for (unsigned int i = 0; i < signal_length2; i++) {
    ...
    std::cout << std::endl;
    for (unsigned int i = 0; i < signal_length3; i++) {
    ...
    std::cout << std::endl;
    for (unsigned int i = 0; i < signal_length4; i++) {
    ...
    std::cout << std::endl;
    for (unsigned int i = 0; i < signal_length5; i++) {
...
void TEST_downSamplingBinomial() {
    ...
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BINOMIAL, 3>(signal_data, signal_length, signal_data2);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BINOMIAL, 3>(signal_data2, signal_length2, signal_data3);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BINOMIAL, 3>(signal_data3, signal_length3, signal_data4);
    fastdtw_cpp::downsampling::downSample<double, 2, FILTER_TYPE_BINOMIAL, 3>(signal_data4, signal_length4, signal_data5);
